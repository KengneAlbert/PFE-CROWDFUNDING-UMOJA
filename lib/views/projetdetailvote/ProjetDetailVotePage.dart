...
import 'package:umoja/views/projetdetailvote/ProjetDetailVotePageContaint.dart';
import '../generalLayouts/ContainerBottom.dart';

class ProjetDetailVotePage extends StatelessWidget {
  final String projectId;

  ProjetDetailVotePage({required this.projectId});
          ...
          return Scaffold(
            body: CustomScrollView(
              slivers: [
                ...
                SliverToBoxAdapter(
                  child: ProjetDetailVotePageContaint(projectId: projectId),
                ),
              ],
            ),
