...
import 'package:umoja/viewmodels/finance/withdraw_viewModel.dart';

class WithdrawPage extends ConsumerWidget {
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final withdrawViewModel = ref.watch(withdrawViewModelProvider);
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 24),
            // ... (Ajoutez un champ de saisie pour le montant)
            Spacer(),
            CustomBouton(
              label: "Withdraw",
              onPressed: () {
                ref.read(withdrawViewModelProvider.notifier).withdraw();
              },
            ),
            SizedBox(height: 16),
          ],
...
// import 'package:umoja/views/profile/withdraw_method_page.dart';
